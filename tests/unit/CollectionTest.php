...
class Collection extends TestCase
{
     ...
     * @test
     */
    public function collection_can_be_merged_another_collection()
    {
    ...
    {
        $collection = new \App\Support\Collection(['four','five']);
        $collection->add(['one','two']);
    ...
    public function returns_json_encode_items()
    {
        ...
        $this->assertEquals('[{"username":"hendro"},{"username":"rahmat"}]', $collection->toJson());
    }
    ...
    public function json_encoding_a_collection_object_returns_json()
    {
        ...
        $this->assertEquals('[{"username":"hendro"},{"username":"rahmat"}]', $encoded);
